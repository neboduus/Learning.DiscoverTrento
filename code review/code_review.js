//* TUTTI I COMMENTI DELLA FORMA /*##### commento #####*/ FANNO PARTE DELLA REVIEW

/*######
 * CODE REVIEW 
 * LE GRAFE {...} CHE DELIMITANO I BLOCCHI DI CODICE NON SONO SEMPRE FATTE UGUALI, A VOLTE LA GRAFA CHE APRE UN BLOCCO SI TROVA AD INIZIO RIGA ALTRE VOLE DUE RIGHE PRIMA
 * SI POTREBBERO CREARE DELLE STRUTTURE DATI PER CERCARE DI SINTETIZZARE I DATI E PER DARE PIÙ MODULARITÀ E RIUSABILITÀ AL CODICE.
 * GLI SPAZI CHE CI SONO TRA I VARI STATEMENTS NON SEMPRE SONO UGUALI, A VOLTE NON CI SONO RIGHE VUOTE TRA GLI SPAZI ALTRE VOLTE CE NE SONO TROPPI, QUESTA COSA ROVINA LA STRUTTURA DEL CODICE RENDENDOLO MENO LEGIBILE E CAPIBILE 
 * ANCHE LA DEFINIZIONE DEGLI ARRAY NON É SEMPRE UGUALE
 * I COMMENTI A VOLTE MANCANO E SI FA FATICA A CAPIRE VELOCEMENTE TEMPO COSA FACCIA UNA DETERMINATA FUNZIONE
 #####*/
...
var path = require('path'); /*##### A COSA SERVE QUESTO IMPORT?? #####*/
